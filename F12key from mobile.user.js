...
//DivFarmPlotPrice.insertBefore(imgHammer1, DivFarmPlotPrice.childNodes[0]);
DivFarmPlotPrice.style.position = "relative";
DivFarmPlotPrice.style.left = "20px";
DivFarmPlotPrice.style.top = "0px";
...
DivBuild.style.left = "10px";
DivBuild.style.top = "5px";
...
DivFarmPlotPriceNBuild.style.left = "20px";
DivFarmPlotPriceNBuild.style.top = "5px";
...
var imgHammer2 = document.createElement("img");
imgHammer2.setAttribute("id", "imgHammer2");
imgHammer2.setAttribute("src", "data:image/png;base64,");
imgHammer2.setAttribute("width", "12");
imgHammer2.setAttribute("height", "12");

var DivBarleySeed = document.createElement("div");
var SpanDivBarleySeed = document.createElement("span");
var ContentDivBarleySeed = document.createTextNode("Test");
SpanDivBarleySeed.setAttribute("id", "SpanDivBarleySeed");
SpanDivBarleySeed.appendChild(ContentDivBarleySeed);
DivBarleySeed.appendChild(SpanDivBarleySeed);
//DivBarleySeed.insertBefore(imgHammer2, DivBarleySeed.childNodes[0]);
DivBarleySeed.style.position = "relative";
DivBarleySeed.style.left = "10px";
DivBarleySeed.style.top = "10px";
...
DivCost.style.left = "20px";
DivCost.style.top = "10px";
...
DivIncome.style.left = "10px";
DivIncome.style.top = "15px";
DivIncome.style.backgroundColor ="#212529";
DivIncome.setAttribute("id", "DivIncome");
DivIncome.setAttribute("class", "badge gradbg-cyan sm");
...
DivCostPerWeek.style.left = "20px";
DivCostPerWeek.style.top = "15px";
...
DivProfitPerWeek.style.left = "10px";
DivProfitPerWeek.style.top = "20px";
...
var DivCostPer1Plot2Week = document.createElement("div");
var ContentCostPer1Plot2Week = document.createTextNode("");
DivCostPer1Plot2Week.appendChild(ContentCostPer1Plot2Week);
//DivCostPer1Plot2Week.innerText = "DivCostPer1Plot2Week   "+DivCostPer1Plot2Week+" ￦";
DivCostPer1Plot2Week.style.color = "white";
...
DivCostPer1Plot2Week.setAttribute("id", "DivCostPer1Plot2Week");
DivCostPer1Plot2Week.setAttribute("class", "badge sm");
document.body.appendChild(DivCostPer1Plot2Week);
...
DivCostPer3Plot1Week.style.top = "60px";
...
var DivCostPer3Plot2Week = document.createElement("div");
var ContentCostPer3Plot2Week = document.createTextNode("");
DivCostPer3Plot2Week.appendChild(ContentCostPer3Plot2Week);
//DivCostPer3Plot2Week.innerText = "DivCostPer3Plot2Week   "+DivCostPer3Plot2Week+" ￦";
DivCostPer3Plot2Week.style.color = "white";
//DivCostPer3Plot2Week.style.fontSize = "xx-large";
DivCostPer3Plot2Week.style.position = "relative";
DivCostPer3Plot2Week.style.left = "0px";
DivCostPer3Plot2Week.style.top = "65px";
DivCostPer3Plot2Week.style.backgroundColor ="#212529";
DivCostPer3Plot2Week.setAttribute("id", "DivCostPer3Plot2Week");
DivCostPer3Plot2Week.setAttribute("class", "badge sm");
document.body.appendChild(DivCostPer3Plot2Week);
...
DivCostPer4Plot1Week.style.top = "70px";
...
var DivCostPer4Plot2Week = document.createElement("div");
var ContentCostPer4Plot2Week = document.createTextNode("");
DivCostPer4Plot2Week.appendChild(ContentCostPer4Plot2Week);
//DivCostPer4Plot2Week.innerText = "DivCostPer4Plot2Week   "+DivCostPer4Plot2Week+" ￦";
DivCostPer4Plot2Week.style.color = "white";
//DivCostPer4Plot2Week.style.fontSize = "xx-large";
DivCostPer4Plot2Week.style.position = "relative";
DivCostPer4Plot2Week.style.left = "0px";
DivCostPer4Plot2Week.style.top = "75px";
DivCostPer4Plot2Week.style.backgroundColor ="#212529";
DivCostPer4Plot2Week.setAttribute("id", "DivCostPer4Plot2Week");
DivCostPer4Plot2Week.setAttribute("class", "badge sm");
document.body.appendChild(DivCostPer4Plot2Week);
...
DivCostPer5Plot1Week.style.top = "80px";
...
var DivCostPer5Plot2Week = document.createElement("div");
var ContentCostPer5Plot2Week = document.createTextNode("");
DivCostPer5Plot2Week.appendChild(ContentCostPer5Plot2Week);
//DivCostPer5Plot2Week.innerText = "DivCostPer5Plot2Week   "+DivCostPer5Plot2Week+" ￦";
DivCostPer5Plot2Week.style.color = "white";
//DivCostPer5Plot2Week.style.fontSize = "xx-large";
DivCostPer5Plot2Week.style.position = "relative";
DivCostPer5Plot2Week.style.left = "0px";
DivCostPer5Plot2Week.style.top = "85px";
DivCostPer5Plot2Week.style.backgroundColor ="#212529";
DivCostPer5Plot2Week.setAttribute("id", "DivCostPer5Plot2Week");
DivCostPer5Plot2Week.setAttribute("class", "badge sm");
document.body.appendChild(DivCostPer5Plot2Week);
...
DivCostPer6Plot1Week.style.top = "90px";
...
var DivCostPer6Plot2Week = document.createElement("div");
var ContentCostPer6Plot2Week = document.createTextNode("");
DivCostPer6Plot2Week.appendChild(ContentCostPer6Plot2Week);
//DivCostPer6Plot2Week.innerText = "DivCostPer6Plot2Week   "+DivCostPer6Plot2Week+" ￦";
DivCostPer6Plot2Week.style.color = "white";
//DivCostPer6Plot2Week.style.fontSize = "xx-large";
DivCostPer6Plot2Week.style.position = "relative";
DivCostPer6Plot2Week.style.left = "0px";
DivCostPer6Plot2Week.style.top = "95px";
DivCostPer6Plot2Week.style.backgroundColor ="#212529";
DivCostPer6Plot2Week.setAttribute("id", "DivCostPer6Plot2Week");
DivCostPer6Plot2Week.setAttribute("class", "badge sm");
document.body.appendChild(DivCostPer6Plot2Week);
...
DivCostPer7Plot1Week.style.top = "100px";
...
var DivCostPer7Plot2Week = document.createElement("div");
var ContentCostPer7Plot2Week = document.createTextNode("");
DivCostPer7Plot2Week.appendChild(ContentCostPer7Plot2Week);
//DivCostPer7Plot2Week.innerText = "DivCostPer7Plot2Week   "+DivCostPer7Plot2Week+" ￦";
DivCostPer7Plot2Week.style.color = "white";
//DivCostPer7Plot2Week.style.fontSize = "xx-large";
DivCostPer7Plot2Week.style.position = "relative";
DivCostPer7Plot2Week.style.left = "0px";
DivCostPer7Plot2Week.style.top = "105px";
DivCostPer7Plot2Week.style.backgroundColor ="#212529";
DivCostPer7Plot2Week.setAttribute("id", "DivCostPer7Plot2Week");
DivCostPer7Plot2Week.setAttribute("class", "badge sm");
document.body.appendChild(DivCostPer7Plot2Week);
...
DivCostPer8Plot1Week.style.top = "110px";
...
var DivCostPer8Plot2Week = document.createElement("div");
var ContentCostPer8Plot2Week = document.createTextNode("");
DivCostPer8Plot2Week.appendChild(ContentCostPer8Plot2Week);
//DivCostPer8Plot2Week.innerText = "DivCostPer8Plot2Week   "+DivCostPer8Plot2Week+" ￦";
DivCostPer8Plot2Week.style.color = "white";
//DivCostPer8Plot2Week.style.fontSize = "xx-large";
DivCostPer8Plot2Week.style.position = "relative";
DivCostPer8Plot2Week.style.left = "0px";
DivCostPer8Plot2Week.style.top = "110px";
DivCostPer8Plot2Week.style.backgroundColor ="#212529";
DivCostPer8Plot2Week.setAttribute("id", "DivCostPer8Plot2Week");
DivCostPer8Plot2Week.setAttribute("class", "badge sm");
document.body.appendChild(DivCostPer8Plot2Week);
...
function chgList(){
    ...
    if(!isNaN(FarmPlotAtomic) &&(FarmPlotAtomic>FarmPlotCraftCost)){
        ...
        document.querySelector("#imgHammer1").style.visibility="hidden";
    }else{
    ...
    if(!isNaN(BarleySeedAtomic) && (BarleySeedAtomic>BarleySeedIngame)){
        var BarleySeedPrice=BarleySeedIngame;
        DivBarleySeed.insertBefore(imgHammer2, DivBarleySeed.childNodes[0]);
    }else if(BarleySeedIngame>BarleySeedAtomic){
        BarleySeedPrice=BarleySeedAtomic;
        document.querySelector("#imgHammer2").style.visibility="hidden";
    }else{
        BarleySeedPrice=BarleySeedIngame;
        DivBarleySeed.insertBefore(imgHammer2, DivBarleySeed.childNodes[0]);
    }
    document.getElementById("SpanDivBarleySeed").innerText="BARLEY SEED   "+BarleySeedPrice+" ￦ "+(BarleySeedPrice*WAXPTHB).toFixed(0) +" บาท";
    ...
    document.getElementById("DivCostPer3Plot2Week").innerText="3Plot2W "+CostPer3Plot1Week+" ￦ "+(CostPer3Plot1Week*WAXPTHB).toFixed(0) +" บาท PF "+Profit3Plot2W+" ￦ "+(Profit3Plot2W*WAXPTHB).toFixed(0)+" บาท "+PercentProfit3Plot2W+"%";
    
    var CostPer4Plot1Week=FarmPlotR+(CostPerWeek*4);
    var Profit4Plot1W=(Profit*4);
    var Profit4Plot2W=(Profit*4*2);
    var PercentProfit4Plot1W=((Profit4Plot1W/CostPer4Plot1Week)*100).toFixed(2);
    var PercentProfit4Plot2W=((Profit4Plot2W/CostPer4Plot1Week)*100).toFixed(2);
    ...
    document.getElementById("DivCostPer4Plot2Week").innerText="4Plot2W "+CostPer4Plot1Week+" ￦ "+(CostPer4Plot1Week*WAXPTHB).toFixed(0) +" บาท PF "+Profit4Plot2W+" ￦ "+(Profit4Plot2W*WAXPTHB).toFixed(0)+" บาท "+PercentProfit4Plot2W+"%";

    var CostPer5Plot1Week=FarmPlotR+(CostPerWeek*5);
    var Profit5Plot1W=(Profit*5);
    var Profit5Plot2W=(Profit*5*2);
    var PercentProfit5Plot1W=((Profit5Plot1W/CostPer5Plot1Week)*100).toFixed(2);
    var PercentProfit5Plot2W=((Profit5Plot2W/CostPer5Plot1Week)*100).toFixed(2);
    ...
    document.getElementById("DivCostPer5Plot2Week").innerText="5Plot2W "+CostPer5Plot1Week+" ￦ "+(CostPer5Plot1Week*WAXPTHB).toFixed(0) +" บาท PF "+Profit5Plot2W+" ￦ "+(Profit5Plot2W*WAXPTHB).toFixed(0)+" บาท "+PercentProfit5Plot2W+"%";

    var CostPer6Plot1Week=FarmPlotR+(CostPerWeek*6);
    var Profit6Plot1W=(Profit*6);
    var Profit6Plot2W=(Profit*6*2);
    var PercentProfit6Plot1W=((Profit6Plot1W/CostPer6Plot1Week)*100).toFixed(2);
    var PercentProfit6Plot2W=((Profit6Plot2W/CostPer6Plot1Week)*100).toFixed(2);
    ...
    document.getElementById("DivCostPer6Plot2Week").innerText="6Plot2W "+CostPer6Plot1Week+" ￦ "+(CostPer6Plot1Week*WAXPTHB).toFixed(0) +" บาท PF "+Profit6Plot2W+" ￦ "+(Profit6Plot2W*WAXPTHB).toFixed(0)+" บาท "+PercentProfit6Plot2W+"%";

    var CostPer7Plot1Week=FarmPlotR+(CostPerWeek*7);
    var Profit7Plot1W=(Profit*7);
    var Profit7Plot2W=(Profit*7*2);
    var PercentProfit7Plot1W=((Profit7Plot1W/CostPer7Plot1Week)*100).toFixed(2);
    var PercentProfit7Plot2W=((Profit7Plot2W/CostPer7Plot1Week)*100).toFixed(2);
    ...
    document.getElementById("DivCostPer7Plot2Week").innerText="7Plot2W "+CostPer7Plot1Week+" ￦ "+(CostPer7Plot1Week*WAXPTHB).toFixed(0) +" บาท PF "+Profit7Plot2W+" ￦ "+(Profit7Plot2W*WAXPTHB).toFixed(0)+" บาท "+PercentProfit7Plot2W+"%";

    var CostPer8Plot1Week=FarmPlotR+(CostPerWeek*8);
    var Profit8Plot1W=(Profit*8);
    var Profit8Plot2W=(Profit*8*2);
    var PercentProfit8Plot1W=((Profit8Plot1W/CostPer8Plot1Week)*100).toFixed(2);
    var PercentProfit8Plot2W=((Profit8Plot2W/CostPer8Plot1Week)*100).toFixed(2);
    ...
    document.getElementById("DivCostPer8Plot2Week").innerText="8Plot2W "+CostPer8Plot1Week+" ￦ "+(CostPer8Plot1Week*WAXPTHB).toFixed(0) +" บาท PF "+Profit8Plot2W+" ￦ "+(Profit8Plot2W*WAXPTHB).toFixed(0)+" บาท "+PercentProfit8Plot2W+"%"; 
