...
// @grant        none
// ==/UserScript==
document.addEventListener('scroll', chkTargetTop);
var targetTop=window.scrollY+document.querySelector("#listFarmingRaising > div:nth-child(1) > div").getBoundingClientRect().top;
function chkTargetTop() {
    var newTargetTop=window.scrollY+document.querySelector("#listFarmingRaising > div:nth-child(1) > div").getBoundingClientRect().top;
    if(targetTop!=newTargetTop){
        targetTop=newTargetTop;
        document.getElementById("DivWAXPTHB").style.top=newTargetTop+"px";
        document.getElementById("DivFarmPlotPrice").style.top=newTargetTop+40+"px";
        document.getElementById("DivBuild").style.top=newTargetTop+65+"px";
        document.getElementById("btn1").style.top=newTargetTop+40+"px";
        document.getElementById("DivFarmPlotPriceNBuild").style.top=newTargetTop+90+"px";
        document.getElementById("DivBarleySeed").style.top=newTargetTop+115+"px";
        document.getElementById("DivCost").style.top=newTargetTop+140+"px";
        document.getElementById("DivIncome").style.top=newTargetTop+165+"px";
        document.getElementById("DivCostPerWeek").style.top=newTargetTop+190+"px";
        document.getElementById("DivProfitPerWeek").style.top=newTargetTop+215+"px";

        document.getElementById("DivCostPer1Plot1Week").style.top=newTargetTop+250+"px";
        document.getElementById("DivCostPer2Plot1Week").style.top=newTargetTop+275+"px";
        document.getElementById("DivCostPer3Plot1Week").style.top=newTargetTop+300+"px";
        document.getElementById("DivCostPer4Plot1Week").style.top=newTargetTop+325+"px";
        document.getElementById("DivCostPer5Plot1Week").style.top=newTargetTop+350+"px";
        document.getElementById("DivCostPer6Plot1Week").style.top=newTargetTop+375+"px";
        document.getElementById("DivCostPer7Plot1Week").style.top=newTargetTop+400+"px";
        document.getElementById("DivCostPer8Plot1Week").style.top=newTargetTop+425+"px";
...
DivWAXPTHB.style.position = "absolute";
DivWAXPTHB.style.left = "170px";
DivWAXPTHB.style.top = targetTop+"px";
...
DivBuild.style.position = "absolute";
DivBuild.style.left = "170px";
DivBuild.style.top = targetTop+65+"px";
...
DivFarmPlotPriceNBuild.style.position = "absolute";
DivFarmPlotPriceNBuild.style.left = "170px";
DivFarmPlotPriceNBuild.style.top = targetTop+90+"px";
...
DivBarleySeed.style.top = targetTop+40+"px";
...
DivCost.style.position = "absolute";
DivCost.style.left = "170px";
DivCost.style.top = targetTop+140+"px";
...
DivIncome.style.position = "absolute";
DivIncome.style.left = "170px";
DivIncome.style.top = targetTop+165+"px";
...
DivCostPerWeek.style.position = "absolute";
DivCostPerWeek.style.left = "170px";
DivCostPerWeek.style.top = targetTop+190+"px";
...
DivProfitPerWeek.style.left = "170px";
DivProfitPerWeek.style.top = targetTop+215+"px";
...
DivCostPer1Plot1Week.style.position = "absolute";
DivCostPer1Plot1Week.style.left = "0px";
DivCostPer1Plot1Week.style.top = targetTop+250+"px";
...
DivCostPer2Plot1Week.style.position = "absolute";
DivCostPer2Plot1Week.style.left = "0px";
DivCostPer2Plot1Week.style.top = targetTop+275+"px";
...
DivCostPer3Plot1Week.style.position = "absolute";
DivCostPer3Plot1Week.style.left = "0px";
DivCostPer3Plot1Week.style.top = targetTop+300+"px";
...
//DivCostPer3Plot1Week.style.fontSize = "xx-large";
DivCostPer4Plot1Week.style.position = "absolute";
DivCostPer4Plot1Week.style.left = "0px";
DivCostPer4Plot1Week.style.top = targetTop+325+"px";
...
DivCostPer5Plot1Week.style.position = "absolute";
DivCostPer5Plot1Week.style.left = "0px";
DivCostPer5Plot1Week.style.top = targetTop+350+"px";
...
DivCostPer6Plot1Week.style.position = "absolute";
DivCostPer6Plot1Week.style.left = "0px";
DivCostPer6Plot1Week.style.top = targetTop+375+"px";
...
DivCostPer7Plot1Week.style.position = "absolute";
DivCostPer7Plot1Week.style.left = "0px";
DivCostPer7Plot1Week.style.top = targetTop+400+"px";
...
DivCostPer8Plot1Week.style.position = "absolute";
DivCostPer8Plot1Week.style.left = "0px";
DivCostPer8Plot1Week.style.top = targetTop+425+"px";
...
//DivCostPer8Plot1Week.appendChild(ContentCostPer8Plot1Week);
//DivCostPer8Plot1Week.innerText = "DivCostPer8Plot1Week   "+DivCostPer8Plot1Week+" ￦";
//imgHammer.style.color = "white";
//DivCostPer8Plot1Week.style.fontSize = "xx-large";
//imgHammer.style.position = "absolute";
//imgHammer.style.left = "0px";
//imgHammer.style.top = targetTop+425+"px";
//imgHammer.style.backgroundColor ="#212529";
...
//imgHammer.setAttribute("width", "16");
//imgHammer.setAttribute("height", "16");
//imgHammer.setAttribute("class", "badge sm");
//document.body.appendChild(imgHammer);
